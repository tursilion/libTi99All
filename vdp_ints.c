...
/*
   ...
   3            * enable ints: write byte 1 to 0xa100
   4            * disable ints: write byte 2 to 0xa100
   5            * all else ignored
   6                aorg >A000
   8  A000 04E0     clr @>83C4      * we came in via interrupt hook
   8  A002 83C4  
   9  A004 02E0     LWPI >8300      * C workspace
   9  A006 8300  
  10  A008 04C1     clr r1
  11            LP0
  12  A00A 04E0     clr @>A100      * our command address
  12  A00C A100  
  13            LP1
