...
#endif
#ifdef COLECO
// this is of limited value. Maybe we can port a sample-based synth in the future
// or support the one used on the JuiceBox... but for now, all stubbed out
// (or maybe even text onscreen...)
