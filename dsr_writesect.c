...
#else 
unsigned char writesector(const char *szPath, unsigned int vdp, unsigned int sector_low, unsigned int sector_high) { return DSR_ERR_DSRNOTFOUND; }
