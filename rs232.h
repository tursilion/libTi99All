...
// A lot of this is meaningless on the Colecovision, but it will send bytes to port 0
// for a debug hardware that I never actually built. ;) PIO will write to port 1,
// in case you decide that matters
